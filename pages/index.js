        ...
        >
          ...
          <Container>
            <m.div variants={fade}>
              ...
              <div className="flex justify-center mb-[25vw] md:mb-[16vw] md:mt-[-3.5vw]">
                <div className="w-full md:w-11/12 max-w-screen-3xl mx-auto">
                  <div className="flex flex-wrap justify-center md:-mx-4">
                  <Link href="/">
                      <a className="w-full md:w-1/3 md:px-4 hidden md:block relative group pt-2 md:pt-4 xl:pt-6 2xl:pt-10">
                        <div className="relative z-10">
                          <div className="w-9/12 mx-auto mb-6" data-scroll data-scroll-speed="0.25">
                            <Image
                              ...
                              alt="Placeholder"
                              layout="responsive"
                              className="w-full group-hover:scale-110 transition ease-in-out duration-500 delay-75 group-hover:-rotate-6"
                              placeholder="blur"
                            />
                          </div>
                          ...
                          <span className="block text-[32px] md:text-[38px] xl:text-[48px] leading-[0.82] font-display uppercase text-center mb-2 md:mb-4 transition-colors ease-in-out duration-500 group-hover:text-yellow">Dino Tee</span>
                          
                          <span className="block text-[22px] md:text-[24px] xl:text-[26px] leading-[0.82] uppercase text-center font-mono">$45</span>
                        </div>
                        
                        <div className="absolute top-0 left-0 mt-[20%] ml-[20%] w-32 h-32 z-20 scale-0 group-hover:scale-100 transition ease-in-out duration-500 delay-100">
                        ...
                        <div className="w-full h-full z-0 scale-0 group-hover:scale-110 absolute inset-0 rounded-[5rem] transition ease-in-out duration-500">
