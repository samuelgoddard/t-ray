...
export default function CartTray({ cart, checkoutUrl }) {
  ...
  return (
    <div className="h-screen p-5 md:p-10 flex flex-col">
      ...
      <hr className="border-off-white border-t w-full mb-8" />

      <div className="my-auto max-h-[60vh] h-full overflow-scroll">
        <ul>
          {cartItems.map(item => (
            <li key={item.variantId} className="block">
