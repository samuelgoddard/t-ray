  ...
  return (
    ...
        <div id="mc_embed_signup_scroll">
      ...
      <div className="w-10/12 md:w-8/12">
        <p className="text-[22px] md:text-[32px] xl:text-[38px] 2xl:text-[46px] leading-[1.2] tracking-tight mb-5 md:mb-8 transition-colors ease-in-out duration-500">Get updates, drops, advance ticket infomation and more direct to your inbox. No spam!</p>
      </div>
