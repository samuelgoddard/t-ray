      ...
      <a className="group relative block w-full pt-2 md:pt-4 xl:pt-6 2xl:pt-10">
        <div className="relative z-10">
          ...
          <div className="origin-top md:group-hover:rotate-2 transition-transform ease-in-out duration-500">
            ...
            <span className="block text-[16px] md:text-[26px] xl:text-[38px] leading-[1] font-display uppercase text-center mb-3 md:mb-4 md:group-hover:text-yellow transition-colors ease-in-out duration-500">
            ...
            <span className="block text-[16px] md:text-[23px] xl:text-[26px] leading-[0.82] uppercase text-center font-mono">
