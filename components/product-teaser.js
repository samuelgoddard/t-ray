      ...
      <a className="group relative block w-full pt-2 md:pt-4 xl:pt-6 2xl:pt-10">
          ...
          <div className="w-11/12 md:w-10/12 xl:w-9/12 mx-auto mb-1" data-scroll data-scroll-speed="0.25">
            <div className="overflow-hidden relative p-5 md:p-8 xl:p-10 h-[58vw] md:h-[28vw] lg:h-[30vw] xl:h-[30vw] flex flex-wrap">
              <m.div variants={scaleUp} className="w-full">
                <div className="md:group-hover:scale-110 transition ease-in-out duration-500 delay-75 md:group-hover:-rotate-6 h-full items-center flex">
        ...
        <div className="absolute top-0 left-0 mt-[20%] ml-[20%] md:w-24 xl:w-32 md:h-24 xl:h-32 z-20 scale-0 md:group-hover:scale-100 transition ease-in-out duration-500 delay-100">
          <div className="hover:scale-125 transition ease-in-out duration-300">
            <div className="motion-safe:animate-spin-slow origin-center md:w-24 xl:w-36 md:h-24 xl:h-36 hidden md:flex flex-wrap items-center justify-center font-mono upperase md:text-[18px] xl:text-[22px] text-center leading-tight">
        ...
        <div className="w-full h-full z-0 scale-0 md:group-hover:scale-110 absolute inset-0 rounded-[5rem] transition ease-in-out duration-500 mt-[2vw]">
