      ...
      <div className="w-full">
        <div className={`flex flex-wrap md:mx-[-3vw] ${image ? 'items-center' : '' }`}>
          <div className="w-full md:w-6/12 xl:w-7/12 md:px-[3vw] mb-8 md:mb-0">
            ...
            { externalLinkUrl && externalLinkText && (
              <div className="mb-4 md:mb-8 xl:mb-12">
                <a rel="noopener noreferrer" className="block uppercase " href={externalLinkUrl}><span className="inline-block underline transition-colors ease-in-out duration-500">{externalLinkText}</span> <span className="text-red dark:text-yellow transition-colors ease-in-out duration-500">→</span></a>
              </div>
            )}
          ...
          <div className="w-full md:w-6/12 xl:w-5/12 md:px-[3vw]" data-scroll data-scroll-speed="0.65">
            <div className="text-[19px] md:text-[22px] xl:text-[24px] 2xl:text-[26px] leading-[1.175] text-indent tracking-tight mb-5 md:mb-8 content transition-colors ease-in-out duration-500">
