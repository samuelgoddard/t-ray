  ...
  return (
    <div className="mb-[12vw] relative">
      <div className="relative z-20">
        ...
        { subHeading && (
          <span className="text-[22px] md:text-[26px] xl:text-[32px] 2xl:text-[40px] leading-[0.95] text-off-black dark:text-off-white text-center block relative z-20">{subHeading}</span>
        )}
      </div>
